...
inputs = { 
    name = "art-unchained-pro-secret-manager-role"
    ...
    oidc_providers = {
        ...
        namespace_service_accounts = ["art-unchained:art-unchained"]
        }
    }

    policies = {
        art-unchained-pro-secret-manager-policy = "arn:aws:iam::${include.envcommon.locals.aws_account_id}:policy/art-unchained-pro-secret-manager-policy"
