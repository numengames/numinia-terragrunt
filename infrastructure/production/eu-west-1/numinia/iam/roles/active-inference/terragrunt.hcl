...
inputs = { 
    name = "active-inference-secret-manager-role"
    ...
    oidc_providers = {
        ...
        namespace_service_accounts = ["active-inference:active-inference"]
        }
    }

    policies = {
        active_inference_pre = "arn:aws:iam::${include.envcommon.locals.aws_account_id}:policy/active-inference-pre-secret-manager-policy"
        active_inference_pro = "arn:aws:iam::${include.envcommon.locals.aws_account_id}:policy/active-inference-pro-secret-manager-policy"
        numinia_statics      = "arn:aws:iam::${include.envcommon.locals.aws_account_id}:policy/numinia-statics-bucket"
    }
